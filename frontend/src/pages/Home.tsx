  ...
  return (
    <div className="auth-card panel content-narrow">
      ...
      <p className="auth-subtitle">
        Track courses, start rounds, and fill in scorecards as you play.
      </p>
      ...
      <div style={{ marginTop: "1.25rem", display: "grid", gap: ".5rem" }}>
        ...
        >
          <li>
            <Link to="/courses">Courses</Link>: create your own 9/18-hole
            courses.
          </li>
          <li>
            <Link to="/round/start">Start Round</Link>: pick a course and start
            a new round.
          </li>
          <li>
            <Link to="/rounds">My Rounds</Link>: view in-progress and completed
            rounds.
          </li>
          <li>
